...
<script>
    ...
    <div class="content__left-right">
        ...
        <div class="review__frame">
            <form action="/review_delete_post" method="post" enctype="multipart/form-data">
            @method('DELETE')
            @csrf
                <input type="hidden" name="shop_id" value="{{ $old_shop_review->shop_id }}">
                    ...
                    <div class="content__comment-frame">
                        ...
                        <div class="comment-textbox">
                            <textarea class="comment" name="comment" cols="45" rows="3" readonly>{{$old_shop_review->comment}}</textarea>
                        </div>
                    ...
                    <div class="content__button-frame">
                        <div class="submit-frame">
                            <button class="submit" onclick='return confirm("口コミを削除してよろしいですか？")'>口コミを削除</button>
                        </div>
