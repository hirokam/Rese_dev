...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'picture_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/sushi.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ];
        ...
        $param = [
            ...
            'picture_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/yakiniku.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ];
        DB::table('shops')->insert($param);
        $param = [
            ...
            'picture_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/izakaya.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ];
        DB::table('shops')->insert($param);
        $param = [
            ...
            'picture_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/italian.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ];
        DB::table('shops')->insert($param);
        $param = [
            ...
            'picture_url' => 'https://coachtech-matter.s3-ap-northeast-1.amazonaws.com/image/ramen.jpg',
            'created_at' => now(),
            'updated_at' => now(),
        ];
        DB::table('shops')->insert($param);
